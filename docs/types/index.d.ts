...
import isDiagonalType = require( '@stdlib/blas-base-assert-is-diagonal-type' );
import isLayout = require( '@stdlib/blas-base-assert-is-layout' );
import isMatrixOrientation = require( '@stdlib/blas-base-assert-is-matrix-orientation' );
import isMatrixTriangle = require( '@stdlib/blas-base-assert-is-matrix-triangle' );
import isOperationSide = require( '@stdlib/blas-base-assert-is-operation-side' );
