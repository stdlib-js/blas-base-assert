...
```javascript
ns = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-assert@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/blas-base-assert/tags). For example,

```javascript
ns = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-assert@v0.1.1-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var ns = require( 'path/to/vendor/umd/blas-base-assert/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-assert@umd/browser.js"></script>
```
...
-   <span class="signature">[`isMatrixOrientation( value )`][@stdlib/blas/base/assert/is-matrix-orientation]</span><span class="delimiter">: </span><span class="description">test if an input value is a matrix orientation.</span>
...
[test-image]: https://github.com/stdlib-js/blas-base-assert/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/blas-base-assert/actions/workflows/test.yml?query=branch:v0.1.1
...
[@stdlib/blas/base/assert/is-diagonal-type]: https://github.com/stdlib-js/blas-base-assert-is-diagonal-type/tree/umd

[@stdlib/blas/base/assert/is-layout]: https://github.com/stdlib-js/blas-base-assert-is-layout/tree/umd

[@stdlib/blas/base/assert/is-matrix-orientation]: https://github.com/stdlib-js/blas-base-assert-is-matrix-orientation/tree/umd

[@stdlib/blas/base/assert/is-matrix-triangle]: https://github.com/stdlib-js/blas-base-assert-is-matrix-triangle/tree/umd

[@stdlib/blas/base/assert/is-operation-side]: https://github.com/stdlib-js/blas-base-assert-is-operation-side/tree/umd

[@stdlib/blas/base/assert/is-transpose-operation]: https://github.com/stdlib-js/blas-base-assert-is-transpose-operation/tree/umd
