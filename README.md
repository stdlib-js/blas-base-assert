...
```javascript
import ns from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-assert@v0.1.0-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { isDiagonalType, isLayout, isMatrixOrientation, isMatrixTriangle, isOperationSide, isTransposeOperation } from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-assert@v0.1.0-deno/mod.js';
```
