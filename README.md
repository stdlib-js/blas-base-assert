...
```javascript
import { isDiagonalType, isLayout, isMatrixOrientation, isMatrixTriangle, isOperationSide, isTransposeOperation } from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-assert@deno/mod.js';
```
